...
import { logger, useNuxt, addPlugin } from '@nuxt/kit';
...
import { R as ROUTE_ENTRY, a as ROUTE_ANALYZE, b as ROUTE_CLIENT } from '../shared/devtools.a2798b81.mjs';
...
function setupAnalyzeBuildRPC({ nuxt, refresh }) {
  ...
  async function startAnalyzeBuild(name) {
    ...
    promise = result.getProcess().then(() => readBuildInfo()).finally(() => {
      promise = void 0;
      initalized = void 0;
      refresh("getAnalyzeBuildInfo");
    });
